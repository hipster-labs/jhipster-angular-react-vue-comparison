package tech.jhipster.vuejs.demo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tech.jhipster.vuejs.demo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tech.jhipster.vuejs.demo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
